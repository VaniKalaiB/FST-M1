...
public class sendSms {
        ...
        public void smsTest() {
            ...
            driver.findElement(MobileBy.AndroidUIAutomator(contactBoxLocator)).sendKeys("9003735009");
            ...
            // Type in a message
            driver.findElement(MobileBy.AndroidUIAutomator("resourceId(\"com.google.android.apps.messaging:id/compose_message_text\")")).sendKeys("Hello!!");
            ...
            Assert.assertEquals(sentMessageText, "Hello!!");
        }
